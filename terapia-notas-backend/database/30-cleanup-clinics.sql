-- =============================================
-- Script: 30-cleanup-clinics.sql
-- Descripción: Limpiar clínicas, mantener solo FAMILY HEALTH COMMUNITY y PHP MENTAL HEALTH CENTER INC.
-- Fecha: 2024-01-15
-- =============================================
...
-- Eliminar grupos asociados a clínicas que no queremos
DELETE FROM groups 
WHERE clinic_id IN (
  SELECT clinic_id 
  FROM clinics 
...
-- Eliminar pacientes asociados a clínicas que no queremos
